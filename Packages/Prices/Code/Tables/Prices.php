...
namespace Businesses\Packages\Prices\Code\Tables;
 ...
 * Prices
 *
 * @ORM\Table(name="businesses_packages_prices", indexes={@ORM\Index(name="package_id_index", columns={"package_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
